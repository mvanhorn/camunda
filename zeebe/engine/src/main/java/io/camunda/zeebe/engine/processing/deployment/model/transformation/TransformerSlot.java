 ...
 * or be reused — they key the per-process versions persisted in {@code
 * PROCESS_TRANSFORMER_VERSIONS}. Add new slots with the next free id; never renumber existing ones.
 */
