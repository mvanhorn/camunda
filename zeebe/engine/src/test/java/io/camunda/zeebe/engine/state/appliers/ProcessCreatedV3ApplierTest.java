...
class ProcessCreatedV3ApplierTest {
  ...
  @Test
  void shouldHaveEmptyTransformerVersionsConstant() {
    // given / when / then — frozen forever; changing this breaks replay determinism
    assertThat(ProcessCreatedV3Applier.TRANSFORMER_VERSIONS).isEmpty();
  }
}
