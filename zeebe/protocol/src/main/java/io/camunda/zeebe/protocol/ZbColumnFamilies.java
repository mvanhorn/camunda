...
public enum ZbColumnFamilies implements EnumValue, ScopedColumnFamily {
  ...
  GLOBAL_LISTENERS(130, GLOBAL),
  GLOBAL_LISTENER_CURRENT_CONFIG(131, GLOBAL),
  GLOBAL_LISTENER_VERSIONED_CONFIG(132, PARTITION_LOCAL),
  GLOBAL_LISTENER_PINNED_CONFIG(133, PARTITION_LOCAL),

  CONDITIONAL_SUBSCRIPTION_PROCESS_INSTANCE_COUNT(134, PARTITION_LOCAL),

  // job metrics
  JOB_METRICS(135, PARTITION_LOCAL),
  JOB_METRICS_STRING_ENCODING(136, PARTITION_LOCAL),
  JOB_METRICS_META(137, PARTITION_LOCAL),
