  ...
  void shouldMapSearchResponse() {
    ...
    assertSoftly(
        softly -> {
          ...
          final AgentInstanceHistory.Metrics metrics = item.getMetrics();
          ...
          final AgentInstanceHistory.ToolCall toolCall = item.getToolCalls().get(0);
          ...
          final AgentInstanceHistory.Content content = item.getContent().get(0);
          softly.assertThat(content.getContentType()).as("contentType").isEqualTo("TEXT");
          softly
              .assertThat(content)
              .as("content is TextContent")
              .isInstanceOf(AgentInstanceHistory.TextContent.class);
          softly
              .assertThat(((AgentInstanceHistory.TextContent) content).getText())
              .as("text")
              .isEqualTo("hello");
        });
  }
