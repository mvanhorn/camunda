...
public class AgentInstanceHistorySearchIT {
  ...
  static void setup() {
    ...
    jobKey =
        waitForJobs(camundaClient, List.of(processInstanceKey)).stream()
    ...
    historyItemKey1 =
        camundaClient
            ...
            .content(List.of(AgentHistoryContent.text("Hello, what can you do?")))
    ...
    historyItemKey2 =
        camundaClient
            ...
            .content(List.of(AgentHistoryContent.text("I can help with many tasks.")))
    ...
    historyItemKey3 =
        camundaClient
            ...
            .elementInstanceKey(elementInstanceKey)
            .jobKey(jobKey)
            .role(AgentHistoryRole.TOOL_RESULT)
            .content(List.of(AgentHistoryContent.text("Search results: ...")))
